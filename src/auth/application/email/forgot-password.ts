export const forgotPasswordEmail = (url: string) => `
    <!DOCTYPE html>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td style="font-size: 14px; line-height: 150%; padding-bottom: 10px;">
                          Has solicitado recuperar tu contraseña. Si no realizaste esta solicitud, ignora este correo.
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td style="padding-bottom: 24px;">
                          <a href="${url}" class="button" title="Recuperar Contraseña">Recuperar Contraseña</a>
                        </td>
                      </tr>
                      <tr>
